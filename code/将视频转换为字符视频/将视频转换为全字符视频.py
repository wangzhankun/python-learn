# https://blog.csdn.net/kongfu_cat/article/details/79681719
#-*- coding:utf-8 -*-
import argparse
import os
import cv2
...
INPUT = args.file
#INPUT = "/home/wang/Documents/github/python-learn/code/将视频转换为字符视频/v.mp4"
OUTPUT = args.output
SAVE = args.save
FPS = args.fps
#像素对应ascii码
...
if __name__=='__main__':
    ...
    #vc = video2txt_jpg("/home/wang/Documents/github/python-learn/code/将视频转换为字符视频/v.mp4")
